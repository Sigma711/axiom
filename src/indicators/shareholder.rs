...
pub struct FScoreInput {
    ...
    pub shares_issued: bool,            // true means new equity was issued (no point)
    pub leverage_decreased: bool,       // Long-term debt/assets decreased
...
/// PDF 第十章 4 节
/// > -1.78 警惕财务操纵
#[allow(clippy::too_many_arguments)] // The public formula has eight named factors.
