...
export function KnowledgeSeriesVisual({ name, result }: { name: string; result: PracticeResult }) {
  ...
  const wide = repainting || result.series.some(series => series.name === 'short_horizon_start' || series.name === 'macd_histogram_x1');
